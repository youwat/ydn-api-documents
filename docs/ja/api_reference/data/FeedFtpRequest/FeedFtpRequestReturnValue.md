# FeedFtpRequestReturnValue
FeedFtpRequestReturnValueオブジェクトは、操作結果を含むFeedHolder報を保持します。
...
| FeedFtpReturnValue|||
| values[1]| [FeedFtpRequestValues](./FeedFtpRequestValues.md)| FeedFtpRequestValuesオブジェクトの配列 |
