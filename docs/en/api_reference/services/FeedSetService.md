# FeedSetService
FeedSetService provides functions to get, add or remove FeedSet information.
...
#### Overview
Use this service to get, add or remove FeedSet information.
...
## get
Retrieves FeedSet information.

#### Request
| Parameter | Requirement | Data Type | Description |
|---|---|---|---|
| selector | Req | [FeedSetSelector](../data/FeedSet/FeedSetSelector.md) | Acquisition condition of FeedSet information |
...
|---|---|---|
| rval | [FeedSetPage](../data/FeedSet/FeedSetPage.md) | FeedSet information that matches acquisition conditions |
...
## mutate(ADD)
Adds FeedSet information.

#### Request
| Parameter | Requirement | Data Type | Description |
|---|---|---|---|
| operations | Req | [FeedSetOperation](../data/FeedSet/FeedSetOperation.md) | FeedSet information to be registered |
